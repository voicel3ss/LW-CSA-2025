...
public class Generator {
    ...
    private Maze maze;
    private static final Color generatePathColor = Color.PINK;
    ...
    private boolean run(Cell cell, Side fromSide){
        ...
        mc.drawPath(cell.getRow(), cell.getCol(), fromSide, generatePathColor);
        mc.drawPath(cell.getRow(), cell.getCol(), Side.Center, generatePathColor);
        cell.removeWall(fromSide);
        ArrayList<Side> sides = shuffle(cell.getWalls());
        for (Side side : sides) {

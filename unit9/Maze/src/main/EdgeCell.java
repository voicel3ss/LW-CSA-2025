...
public class EdgeCell extends ShadedCell {
    ...
    // const
    private static final Color EDGE_COLOR = new Color(255, 182, 193);
    ...
    /**
     * Return list of paths for cell, excluding edges. Removes sides identified as
     * edges from list of paths.
     * 
     * @return an ArrayList of Side representing paths of cell, excluding edges
     */
    @Override
    public ArrayList<Side> getPaths() {
        ArrayList<Side> paths = super.getPaths();
        paths.removeAll(listOfEdges);
        return paths;
    }
}